...
local function switchToggle(menuToggle)
    local isShowingMenu = menuToggle:query().icon.value == icons.text.switch.on

    menuToggle:set({
        icon = isShowingMenu and icons.text.switch.off or icons.text.switch.on,
